...
ITERATIONS=${1:-10}
TARGET="+15042147419"
# Flash SMS PDU: Class 0, message "0"
# 00 = SMS-SUBMIT
# 11 = no reply path, validity period format
# 00 = message reference 0
# 0B 91 51 40 12 74 14 F9 = destination +15042147419
# 00 = no protocol id
# 10 = data coding scheme 0x10 (Class 0, GSM 7-bit)
# 01 = user data length 1
# 30 = message content "0"
PDU="0011000B915140127414F900100130"
PDU_LEN=14
SCADDR="+13123149810"
LOG="/tmp/flash_sms_$$.log"

echo "[$(date '+%H:%M:%S')] Starting Flash SMS sender - $ITERATIONS messages to $TARGET" | tee "$LOG"
